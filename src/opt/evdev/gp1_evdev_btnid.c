...
static int gp1_evdev_default_usage_for_KEY(int code) {
  switch (code) {
...
static int gp1_evdev_default_usage_for_ABS(int code) {
  switch (code) {
...
static int gp1_evdev_default_usage_for_REL(int code) {
  switch (code) {
